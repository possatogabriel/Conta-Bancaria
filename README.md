...
Desafio apresentado no primeiro curso de Java na Alura

Esse projeto simula uma conta bancária que você pode **visualizar sua conta bancária, alterando o nome** registrado nela, assim como **seu saldo, que pode ser transferido ou recebido**
